...
namespace Turmerik.Cloneable
{
    ...
    {
        public interface IClnblCore : IClnbl
        {
        ...
        public abstract class ImmtblCoreBase : IClnblCore
        {
            ...
            IClnbl IClnbl.ToImmtbl() => ToImmtbl();
            IClnbl IClnbl.ToMtbl() => ToMtbl();
            IClnbl IClnbl.AsImmtbl() => AsImmtbl();
            IClnbl IClnbl.AsMtbl() => AsMtbl();
        }
