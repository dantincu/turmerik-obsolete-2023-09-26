...
{
    public static class TreeTraversalComponentOptsCore
    {
        public interface IClnbl<T>
        {
            Func<TreeTraversalComponent<T>.Args, T, Lazy<IEnumerator<T>>> ChildNodesNmrtrRetriever { get; }
        ...
        public class Immtbl<T> : IClnbl<T>
        {
            ...
            public Func<TreeTraversalComponent<T>.Args, T, Lazy<IEnumerator<T>>> ChildNodesNmrtrRetriever { get; }
        ...
        public class Mtbl<T> : IClnbl<T>
        {
            ...
            public Func<TreeTraversalComponent<T>.Args, T, Lazy<IEnumerator<T>>> ChildNodesNmrtrRetriever { get; set; }
