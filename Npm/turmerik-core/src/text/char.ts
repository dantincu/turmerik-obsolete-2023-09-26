...
export const areAllLettersOrNumbers = (str: string) => !!str.match(lettersOrNumbersRegex)

export const areAllLowerCaseLettersOrNumbers = (str: string) => !!str.match(lowerCaseLettersOrNumbersRegex)

export const areAllLowerCaseLetters = (str: string) => !!str.match(lowerCaseLettersRegex)

export const areAllUpperCaseLettersOrNumbers = (str: string) => !!str.match(upperCaseLettersOrNumbersRegex)

export const areAllUpperCaseLetters = (str: string) => !!str.match(upperCaseLettersRegex)

export const isValidCodeIdentifier = (str: string) => !!str.match(codeIdentifierRegex)
