...
const isNullOrUndef = trmrk_core.obj.obj.isNullOrUndef;
...
export class ApiComponent {
  ...
  public post<T, D>(
    ...
    return this.dataRequest(axios.post, uri, data, config);
  }
  ...
  public put<T, D>(
    ...
    return this.dataRequest(axios.put, uri, data, config);
  }
  ...
  public delete<T, D>(
    ...
    return this.request(axios.delete, uri, undefined as D, config);
  }
  ...
  public patch<T, D>(
    ...
    return this.dataRequest(axios.patch, uri, data, config);
  }
